...
const file_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user/v1/user.proto\x12\auser.v1\"g\n" +
	"\x04User\x12\x0e\n" +
	...
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x18.user.v1.GetUserResponseB/Z-github.com/zaouldyeck/taskboard/proto/user/v1b\x06proto3"
